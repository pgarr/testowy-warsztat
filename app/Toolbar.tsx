...
export default function Toolbar() {
  ...
  const linkClass = (path: string) =>
    `toolbar-link${pathname === path ? " active" : ""}`;
  ...
  return (
    <nav className="toolbar">
      ...
      <div className="toolbar-links">
        <Link href="/services" className={linkClass("/services")}>Zakres usług</Link>
        <Link href="/about" className={linkClass("/about")}>O nas</Link>
